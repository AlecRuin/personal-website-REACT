...
export default function Portfolio(){
    return (
        <div className="d-flex m-5 flex-wrap justify-content-between">
            ...
            <div className="card w-25 h-75 d-flex flex-column  my-2 mx-1">
                <img src="./graphics/blogpostsnapshot.png" className="card-img-top h-25 d-flex"alt="Bootleg snapshot"/>
                <div className="card-body h-75 p-3">
                    <p>
            ...
            <div className="card w-25 h-75 d-flex flex-column  my-2 mx-1">
                <img src="./graphics/watchlistsnapshot.png" className="card-img-top h-25 d-flex"alt="Bootleg snapshot"/>
                <div className="card-body h-75 p-3">
                    <p>
